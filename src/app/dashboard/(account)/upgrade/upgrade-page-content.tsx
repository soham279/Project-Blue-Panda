    ...
    <div className="max-w-3xl flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm/6 text-gray-600 max-w-prose">
          {plan === "PRO"
            ? "Thank you for your supporting BluePanda. Find your increased usage limits below."
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="border-2 border-brand-700">
          ...
          <div>
            ...
            <p className="text-xs/5 text-muted-foreground">Events this peiod</p>
          </div>
        </Card>
        <Card>
          <div className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <p className="text-sm text-gray-500">
        Usage will reset{" "}
        {usageData?.resetDate ? (
          format(usageData.resetDate, "MMM dd, yyyy")
        ) : (
